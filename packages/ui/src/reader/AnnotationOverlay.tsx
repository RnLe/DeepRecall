 ...
 *
 * Platform-agnostic component with navigation and upload operations injected
 */
...
import type { AnnotationTool } from "@deeprecall/data";
...
export interface AnnotationOverlayOperations {
  /**
   * Navigate to annotation detail page
   * @example Web: (id) => router.push(`/reader/annotation/${id}`)
   * @example Desktop: (id) => navigate(`/reader/annotation/${id}`)
   */
  navigateToAnnotation: (annotationId: string) => void;

  /**
   * Upload file and create note asset attached to annotation
   * @param annotationId - Annotation to attach note to
   * @param file - File to upload
   * @returns Promise resolving when upload and attachment complete
   */
  uploadAndAttachNote: (annotationId: string, file: File) => Promise<void>;
}

export interface AnnotationOverlayProps extends AnnotationOverlayOperations {
                  ...
                  (() => {
                    ...
                    return (
                      <g
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          navigateToAnnotation(annotation.id);
                        }}
