 ...
 * Platform-agnostic with operations interface
 */
...
// ============================================================================
// PDF Types (platform-agnostic subset)
// ============================================================================
...
export interface AnnotationPreviewOperations {
  /**
   * Get blob URL for PDF loading
   */
   ...
   */
  loadPDFDocument: (url: string) => Promise<PDFDocumentProxy>;

  /**
   * Update annotation metadata with optimistic updates
   */
...
export interface AnnotationPreviewProps {
  ...
  onBack: () => void;
  operations: AnnotationPreviewOperations;
}
...
export function AnnotationPreview({
  ...
  const handleUpdate = async (updates: Partial<Annotation["metadata"]>) => {
    try {
      await operations.updateAnnotationMetadata(annotation.id, updates);
  ...
  }, [showPreviewModal, annotation, data, operations]);
