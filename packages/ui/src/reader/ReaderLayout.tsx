 ...
 *
 * Platform-agnostic layout component using hoisted UI components
 */

"use client";

import { useRef, useEffect, useState, type ComponentType } from "react";
import { useReaderUI, useAnnotationUI } from "@deeprecall/data";
...
export interface AnnotationEditorComponentProps {
  sha256: string;
...
export interface ReaderLayoutProps {
  ...
  /** Platform-specific AnnotationEditor component */
  AnnotationEditorComponent: ComponentType<AnnotationEditorComponentProps>;
}
...
export function ReaderLayout({
  ...
  const { navigateToPage } = useAnnotationUI();
