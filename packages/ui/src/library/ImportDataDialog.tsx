...
// Platform-agnostic import operations interface
...
export function ImportDataDialog({
  ...
  const handleFileSelect = async (selectedFile: File) => {
    ...
    try {
      const result = await importOps.previewImport(selectedFile);
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      const result = await importOps.executeImport(tempId, updatedOptions);
  ...
  const totalConflicts = preview
    ? Object.values(preview.conflicts).reduce(
              ...
              <div className="space-y-2">
                ...
                <div className="p-4 bg-zinc-50 dark:bg-zinc-800/50 rounded-lg space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>
                      {importOps.formatBytes(preview.metadata.sizes.total)}
                    </span>
                  </div>
                </div>
              </div>
