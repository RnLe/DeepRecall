...
const LiteratureCardCompact: React.FC<LiteratureCardCompactProps> = ({ literature }) => {
  const { 
    title, 
    authors: rawAuthors, 
    type,
  ...
  return (
    <div className="group relative bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 rounded-xl p-4 hover:border-slate-600/50 transition-all duration-300 hover:shadow-lg hover:shadow-black/10 aspect-[4/3] flex flex-col">
      {/* Type indicator */}
      ...
      <div className="flex justify-between items-start mb-3">
        ...
        <div className="w-16 h-12 flex-shrink-0 rounded-md overflow-hidden">
          {latestThumbnail ? (
            ...
            <div className={`w-full h-full bg-gradient-to-br ${getTypeColor(type)} opacity-20 rounded-md flex items-center justify-center`}>
