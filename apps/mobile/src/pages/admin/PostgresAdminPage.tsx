/**
 * Postgres Admin Page (Capacitor Mobile)
 * Server-side database viewer via HTTP API
 */
          ...
          <div className="flex gap-6 items-start">
            ...
            <div className="shrink-0">
              ...
              <p className="text-xs text-gray-400 mt-0.5">
                Server-side database - canonical data
              </p>
              <p className="text-xs text-gray-500 mt-0.5 mb-2">
                Persistent server storage — authoritative source
              </p>
              <button
                onClick={handleRefresh}
                disabled={isLoading}
                className="px-3 py-1.5 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-700 disabled:cursor-not-allowed rounded transition-colors text-sm font-medium"
              >
