 ...
 *
 * Client component for OAuth sign-in buttons.
 * Uses server actions for authentication.
 * Shows modal when offline instead of navigating.
 */
...
export function SignInForm({ callbackUrl }: SignInFormProps) {
  ...
  const handleSignIn = async (provider: "google" | "github") => {
    // Check if online before attempting sign-in
    if (!isOnline) {
  ...
  return (
    <div className="space-y-4">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors shadow-sm"
      >
